...
.container {
    display: grid;
    grid-template-columns: repeat(7, 100px); /* 7列 */
    grid-template-rows: auto repeat(3, 100px); /* 1行目自動調整 + 3行 */
    gap: 0; /* 隙間なし */
    justify-content: center;
    margin: 10px auto;
